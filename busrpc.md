...
* file *busrpc.proto*, which is provided by the framework and potentially customized by a specific API implementation (template can be found in the [*proto/*](proto) directory of this repository, customized example in the [*example/api/*](example/api) directory)
